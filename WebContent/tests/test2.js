...
import '../zip-ext.js'; // overrides 
//import '../deflate.js'; // add Deflater to zip
//import '../inflate.js'; // add Inflater to zip
// assume that DataView exists in any es6 browser...
import createTempFile from './util.js';
import './config.js';
...
var blob, requestFileSystem = globalThis.webkitRequestFileSystem || globalThis.mozRequestFileSystem || globalThis.requestFileSystem;
